...
before packages are loaded."
  (let ((cfg (expand-file-name "config" dotspacemacs-directory)))
    (load (expand-file-name "clipboard.el" cfg))
    (load (expand-file-name "cscope.el" cfg))
    (load (expand-file-name "org.el" cfg))
    (load (expand-file-name "mail.el" cfg)))
  )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
                ...
                column-enforce-mode company company-emoji define-word devdocs
                ...
                emoji-cheat-sheet-plus emr eval-sexp-fu evil-anzu evil-args
                ...
                expand-region eyebrowse fancy-battery gh-md golden-ratio
                ...
                treemacs-persp treemacs-projectile undo-fu-session uuidgen valign
                vi-tilde-fringe vmd-mode volatile-highlights vundo wgrep winum
